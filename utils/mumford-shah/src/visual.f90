...
integer :: i,ios,ndim,n

myname='=>write_ensight_geocoord'
ndim=ubound(coord,1)
n=ubound(coord,2)
if(ndim.gt.3 .or. ndim.lt.2 .or. n.ne.nnode)then
...
if(ndim.eq.2)write(11)(zval,i=1,nnode)
return
...
if(ubound(connect,1).ne.4 .or. ubound(connect,2).ne.nelmt)then
