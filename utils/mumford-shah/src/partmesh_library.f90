...
integer :: ios,i_elmt,i_part,ibc,ipart,istat,nbc,bctype
...
ni=0; nj=0
!print*,'hello1:',connect1,isnode1
!print*,'hello2:',connect2,isnode2
i_loop: do i=1,nedge
...
undef_mat_domain,undef_mat_prop,nvisco,imat_visco,muratio,viscosity,           &
...
subroutine write_boundaries_database(out_path,uxfile,uyfile,uzfile,iproc, nelmt, nelmt2D_xmin, nelmt2D_xmax, &
                      nelmt2D_ymin, nelmt2D_ymax, nelmt2D_bottom, nelmt2D_top, &
...
integer,intent(in) :: nelmt !integer(long)
integer,intent(in) :: nelmt2D_xmin,nelmt2D_xmax,nelmt2D_ymin, nelmt2D_ymax,nelmt2D_bottom,nelmt2D_top
...
integer,dimension(nelmt2D_ymax),intent(in) :: ibelm_ymax
integer,dimension(nelmt2D_bottom),intent(in) :: ibelm_bottom
integer,dimension(nelmt2D_top),intent(in) :: ibelm_top
...
integer,dimension(4,nelmt2D_ymax),intent(in) :: nodes_ibelm_ymax
integer,dimension(4,nelmt2D_bottom),intent(in) :: nodes_ibelm_bottom
integer,dimension(4,nelmt2D_top),intent(in) :: nodes_ibelm_top
integer,dimension(:),allocatable :: glob2loc_elmt
integer,dimension(:),allocatable :: glob2loc_nodes_npart
integer,dimension(:),allocatable :: glob2loc_nodes_parts
integer,dimension(:),allocatable :: glob2loc_nodes
...
integer :: loc_nelmt2D_xmin,loc_nelmt2D_xmax,loc_nelmt2D_ymin, &
            loc_nelmt2D_ymax,loc_nelmt2D_bottom,loc_nelmt2D_top
